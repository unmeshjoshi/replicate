...
public class QuorumReadWriteTest {
    ...
    public void compareAndSwapIsSuccessfulForTwoConcurrentClients() throws IOException {
        ...
        replicator.quorumconsensus.KVClient kvClient = new replicator.quorumconsensus.KVClient();
        ...
        replicator.quorumconsensus.KVClient alice = new replicator.quorumconsensus.KVClient();
        ...
        replicator.quorumconsensus.KVClient bob = new replicator.quorumconsensus.KVClient();
        athens.reconnectTo(cyrene);
