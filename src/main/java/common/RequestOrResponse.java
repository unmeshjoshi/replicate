...
public class RequestOrResponse {
    ...
    public RequestOrResponse(Integer groupId, Integer requestId, byte[] messageBodyJson, Integer correlationId) {
        this(groupId, requestId, messageBodyJson, correlationId, null);
    }
    ...
    public RequestOrResponse(int groupId, Integer requestId, byte[] messageBodyJson, Integer correlationId, InetAddressAndPort fromAddress) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(requestId, that.requestId) && Arrays.equals(messageBodyJson, that.messageBodyJson) && Objects.equals(correlationId, that.correlationId) && Objects.equals(groupId, that.groupId) && Objects.equals(fromAddress, that.fromAddress);
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(requestId, correlationId, groupId, fromAddress);
