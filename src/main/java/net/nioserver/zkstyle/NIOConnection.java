package net.nioserver.zkstyle;

import common.*;
import org.apache.logging.log4j.Logger;
import net.ClientConnection;
import net.RequestConsumer;
import net.nioserver.kafkastyle.BoundedByteBufferReceive;
...
public class NIOConnection implements ClientConnection, Logging {
    ...
    private void read(SelectionKey key) throws Exception {
        ...
        if (bytesRead < 0) {
            ...
            requestConsumer.accept(new Message<RequestOrResponse>(request, request.getGroupId(), requestId, this));
